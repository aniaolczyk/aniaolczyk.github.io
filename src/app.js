        ...
        <Router>
            ...
            <footer className="footer">
                <div className="content has-text-centered">
                    ...
                    <div className="footer-elem center social-link">
                        <a href="https://www.facebook.com/profile.php?id=100083688667584" target="_blank" rel="noopener" aria-label="Facebook Ania Olczyk">
                            <FacebookIcon/>
                    ...
                    <div className="footer-elem center social-link">
                        <a href="https://www.youtube.com/@AniaOlczyk" target="_blank" rel="noopener" aria-label="YouTube Ania Olczyk">
                            <YouTubeIcon/>
                            <p className="footer-text">Ania Olczyk</p>
                        </a>
                        <br/>
                    ...
                    <div className="footer-elem center social-link">
                        <a href="https://open.spotify.com/artist/1AfgDOc4Q0Z7LZpdQbU49y" target="_blank" rel="noopener" aria-label="Spotify Ania Olczyk">
                            <SpotifyIcon/>
                            <p className="footer-text">Ania Olczyk</p>
                        </a>
                        <br/>
...
const InstaIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" height="20" fill="white"
...
const FacebookIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" height="20" fill="white" aria-hidden="true">
        <path
...
const SpotifyIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" height="20" fill="white"
         viewBox="0 0 496 512" aria-hidden="true">
        <path
...
function Music() {
    return (
        <section className="section" role="main" aria-label="Muzyka">
            <div className="container is-fluid">
                <h1 className="title header-ania text-black text-uppercase font-bold">
                    Muzyka
                </h1>
                <div className="content">
                    <p className="subtitle text-black text-large">
...
function Concerts() {
    return (
        <section className="section" role="main" aria-label="Koncerty">
            <div className="container is-fluid">
                <h1 className="title header-ania text-black text-uppercase font-bold">
                    Koncerty
                </h1>
...
function Contact() {
    return (
        <section className="section" role="main" aria-label="Kontakt">
            <div className="container is-fluid">
                <h1 className="title header-ania text-black text-uppercase font-bold">
                    Kontakt
                </h1>
                <div className="content">
                    <p className="subtitle text-black text-large">
                        ...
                        <a href="mailto:booking@aniaolczyk.com" className="contact-link">
                            booking@aniaolczyk.com
                        </a>
                        <br/>
                        <strong>Reszta spraw:</strong>{' '}
                        <a href="mailto:info@aniaolczyk.com" className="contact-link">
                            info@aniaolczyk.com
                        </a>
                    </p>
                </div>
